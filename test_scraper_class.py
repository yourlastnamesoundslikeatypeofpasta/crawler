...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_email_with_html_parser(self):
        url = Scraper('https://cannabistheorys.com/cannabis-theorys-muv-product-tutorial-11-thc-cbd-inhaler/')
        url.set_current_url()
        url.set_response_with_html()
        url.get_email_from_response()
        self.assertEqual(1, len(url.email_dict))
        url.print_emails()
...
if __name__ == '__main__':
    # unittest.main()
    MyTestCase.test_get_email_with_html_parser()
